...
export const buildMcpInstructions = () => {
  return [
    ...
    'Recommended gateway tool for all Chemical X operations. Dispatches all sub-operations',
    'through a single tool for token efficiency and single-point authorization.',
    '',

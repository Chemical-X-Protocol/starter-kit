...
export const initTeamSchema = (db) => {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS agent_feed (
      ...
      recipient_id TEXT, thread_id INTEGER, task_id INTEGER, file_path TEXT,
    ...
    CREATE TABLE IF NOT EXISTS file_leases (
      file_path TEXT PRIMARY KEY, locked_by TEXT NOT NULL,
      acquired_at INTEGER NOT NULL, expires_at INTEGER NOT NULL, purpose TEXT NOT NULL DEFAULT ''
    );
    ...
    CREATE INDEX IF NOT EXISTS idx_agent_feed_time ON agent_feed(timestamp);
    CREATE INDEX IF NOT EXISTS idx_agent_feed_thread ON agent_feed(thread_id);
    CREATE INDEX IF NOT EXISTS idx_agent_feed_recipient ON agent_feed(recipient_id);
    CREATE INDEX IF NOT EXISTS idx_file_leases_locked ON file_leases(locked_by);
    CREATE INDEX IF NOT EXISTS idx_file_leases_expiry ON file_leases(expires_at);

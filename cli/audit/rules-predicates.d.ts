...
export declare function isComponentExtension(ext: string): boolean;
export declare function isTemplateExtension(ext: string): boolean;
...
export declare function resolveFirstDefined<T>(...candidates: readonly (T | null | undefined)[]): T | undefined;
export declare function hasMatchingAuditMetrics(a: Record<string, any>, b: Record<string, any>): boolean;
